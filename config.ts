...
export const charmConfig: VaultParams = {
  ...
  baseThreshold: 3600,
  limitThreshold: 1200,
  period: 10 * 86400, // 10 days, actual period between rebalances, not min enforced period, has to be divisible by seconds of lookUpPeriod
...
export const dlvConfig = {
  period: 7 * 86400, // TODO if set very often it may be possible for rebalanceDebt::deposit to revert because of one of the amounts being 0
